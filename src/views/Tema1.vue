...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo.mb-5(data-aos="flip-up")
      ...
      h4.mb-0 Etiqueta de internet o netiqueta
    ...
    p.mb-5(data-aos="fade-left") Todas las conferencias web o sesiones en línea deberán quedar configuradas mínimo dos días hábiles antes a la realización de estas.
    ...
    p.mb-5(data-aos="fade-left") Estas actividades se encuentran descritas en la guía de aprendizaje.

    .titulo.mb-5(data-aos="flip-up")
      img(src='@/assets/curso/temas/ico.svg', alt='Imagen decorativa')
      h4.mb-0 Guía de aprendizaje
    ...
    .titulo.mb-5(data-aos="flip-up")
      img(src='@/assets/curso/temas/ico.svg', alt='Imagen decorativa')
      h4.mb-0 Evidencias de aprendizaje
    ...
    .titulo.mb-5(data-aos="flip-up")
      img(src='@/assets/curso/temas/ico.svg', alt='Imagen decorativa')
      h4.mb-0 Crear grupos en el LMS 
